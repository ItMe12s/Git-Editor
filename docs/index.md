...
- [features/README.md](features/README.md): pause menu map
- [about.md](../about.md): full feature guide (also shown in-game)

## For contributors

- [source/README.md](source/README.md): what each `src/` folder does
