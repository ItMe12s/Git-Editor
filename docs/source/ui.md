...
- `common/ScrollListPopup.hpp`: shared scroll-list popup shell (History, Levels)
...
- [src/ui/HistoryCommitRow.cpp](../../src/ui/HistoryCommitRow.cpp)
- [src/ui/HistoryFlows.cpp](../../src/ui/HistoryFlows.cpp)
- [src/ui/HistoryActions.cpp](../../src/ui/HistoryActions.cpp)
...
- [src/ui/common/PreparedEditorFlow.hpp](../../src/ui/common/PreparedEditorFlow.hpp)
- [src/ui/common/ScrollListPopup.hpp](../../src/ui/common/ScrollListPopup.hpp)
