...
namespace git_editor {
    ...
    HistoryLayer* HistoryLayer::create(
        std::string levelKey, LevelEditorLayer* editor, EditorPauseLayer* pauseLayer
    ) {
    ...
    bool HistoryLayer::init(std::string levelKey, LevelEditorLayer* editor, EditorPauseLayer* pauseLayer) {
        ...
        m_scroll =
            scroll_list_popup::attachScrollList(this, m_mainLayer, "git-editor-history-scroll"_spr);
        ...
        m_headerMenu->setLayout(
            RowLayout::create()->setGap(6.f)->setAxisAlignment(AxisAlignment::End)->setCrossAxisOverflow(true)
        );
