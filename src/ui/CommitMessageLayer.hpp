...
namespace git_editor {
    ...
    public:
        ...
        static CommitMessageLayer* create(
            ConfirmFn onConfirm, std::string title = "New Commit",
            std::string buttonLabel = "Commit", std::string initialText = "", CloseFn onClose = {}
        );

    protected:
        bool init(
            ConfirmFn onConfirm, std::string title, std::string buttonLabel,
            std::string initialText, CloseFn onClose
        );
